    ...
    return (
        <div className='flex h-[100dvh] justify-center items-center'>
            <div className="flex flex-col gap-2 items-center">
                <div className="">
                    <svg aria-label=""
                        fill="currentColor" height="96" role="img" viewBox="0 0 96 96" width="96">
                        <title></title>
                ...
                <div className="text-2xl">Your messages</div>
                <div className="text-[#454545]">Send a message to start a chat.</div>
                <button className="bg-[#0095f6] text-[#efefef] font-semibold px-3 py-2 rounded-md" >Send Message</button>
            </div>
        </div>
    )
}
